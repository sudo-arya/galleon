    ...
    <div className="">
      ...
      <footer className="bg-cs5 text-white shadow-3xl shadow-inner">
        <div
          ...
          }  flex-row justify-center sm:space-y-0 pt-5 hidden md:flex xl:mx-56 mx-4 `}
        >
          <div className="w-1/3 flex flex-col   ">
            <div className="font-bold text-2xl text-cs2  flex flex-col mx-auto w-fit items-center justify-center">
              Galleon Trading
              <hr className="h-2 w-full  border-cs7 pb-1 mt-2" />
            </div>
            <div className="mx-auto">
              ...
              <Link to="/ethics" target="_self">
                <p
                  className="text-white hover:text-facebook hover:bg-cs2 my-1 rounded-xl text-base font-medium cursor-pointer nav-item px-3 w-fit group transform transition-transform duration-500 ease-in-out"
                  style={{ display: "flex", alignItems: "center" }}
                >
                  <span className="text-left p-2">
                    <u>Ethics & Compliance</u>
                  </span>
                </p>
              </Link>
          ...
          <div className="w-1/3  flex flex-col">
            <div className="font-bold text-2xl text-cs2 mb-2 flex flex-col w-fit mx-auto items-center justify-center">
              Follow Us
              <hr className="h-2 w-full  border-cs7 pb-1 mt-2" />
            </div>
            <div className="mx-auto">
                ...
                <button onClick={`${handleAddressClick} `} id="address2">
                  ...
                  >
                    <svg
                      ...
                      height="40"
                      // style={{ fill: "#0081a7" }}
                      className=" pr-1 fill-cs2 group-hover:fill-cs6 xl:-ml-2"
                      viewBox="0 0 48 48"
                    >
                      <defs>
