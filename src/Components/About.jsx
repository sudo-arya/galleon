    ...
    <div className="w-full bg-cs2">
      ...
      <div className="relative h-100 overflow-hidden bg-black w-full">
        ...
        <div className="flex items-center justify-center w-full h-full md:mt-28">
          <div className="relative h-fit flex flex-col justify-center  text-white z-10 bg-slate-200 mx-auto w-100 bg-opacity-80 px-10 py-4 mt-36 md:mt-0 pt-9 pb-9 rounded-xl">
            <h1 className="text-4xl text-cs5 font-bold text-center">
              About Us
            </h1>
      ...
      <div className="h-fit bg-gray-200 flex justify-center w-10/12 my-12 flex-col md:flex-row mx-auto text-white ">
                ...
                <div className="relative w-full h-full">
                  ...
                  <p className="absolute inset-0 w-full h-full text-5xl flex items-start justify-start p-6 font-bold flex-col text-white z-20">
                    ...
                    <span className=" text-base py-3 md:py-8 font-semibold">
                      Sesame seeds are sourced from Mozambique and Burkina Faso.
                      They are used in a variety of culinary applications,
                      including baking, cooking, and oil extraction due to their
        ...
        <div className="md:w-1/3 flex-row">
            ...
            <div className="relative w-full overflow-hidden h-[48.5vh]  transform transition delay-150 ease-in-out group">
              ...
              <p className="absolute inset-0 w-full h-full text-5xl flex items-start justify-start p-6 font-bold flex-col text-white z-20">
                ...
                <span className=" text-base py-1 md:py-8 font-semibold">
                  Sourced from multiple regions, including Tanzania, Mozambique,
                  Nigeria, Ghana, Côte d'Ivoire, Burkina Faso, Guinea Conakry,
                  Senegal, and Guinea Bissau, these are raw cashew nuts still in
                  their shells.
                </span>
                <svg
                  height="512"
          ...
          <div className="w-full">
            <div className="relative w-full aspect-[9/16] contrast-75 transform transition delay-150 ease-in-out group">
              <div className="absolute inset-0 bg-black opacity-55 group-hover:opacity-40 z-10"></div>
            ...
            <div className="relative w-full overflow-hidden h-[48.5vh]  transform transition delay-150 ease-in-out group">
              ...
              <p className="absolute inset-0 w-full h-full text-5xl flex items-start justify-start p-6 font-bold flex-col text-white z-20">
                ...
                <span className=" text-base py-3 md:py-8 font-semibold">
                  ...
                  Côte d'Ivoire, and Mozambique. Cashew kernels are available in
                  various grades and are commonly used in snacks, confectionery,
                  and cooking.
                </span>
                <svg
                  height="512"
              ...
              <div className="relative w-full overflow-hidden h-[48.5vh]  transform transition delay-150 ease-in-out group">
                <div className="relative w-full h-full">
                  ...
                  <p className="absolute inset-0 w-full h-full text-5xl flex items-start justify-start p-6 font-bold flex-col text-white z-20">
                    Cotton
                    <span className=" text-base py-3 md:py-8 font-semibold">
                      Cotton is sourced from Burkina Faso and Côte d'Ivoire. It
                      is a vital raw material for the textile industry, valued
                      for its versatility and softness.
                    </span>
                    <svg
                      height="512"
                      viewBox="0 0 512 512"
                ...
                <div className="relative w-full h-full bg-cs6 text-white">
                  ...
                  <p className="absolute inset-0 w-full h-full text-5xl flex items-start justify-start p-6 font-bold flex-col text-white z-20">
                    ...
                    <span className=" text-base py-3 md:py-8 font-semibold">
                      ...
                      ethics and compliance, ensuring transparency and integrity
                      in all our operations. Our practices are aligned with
                      global norms to foster trust and accountability across our
                      value chain.
                    </span>
                    <svg
                      height="512"
