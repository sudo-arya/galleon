...
const Cotton = () => {
  ...
  return (
    <div className="w-screen bg-cs2 h-fit -mt-1">
      {/* Contact */}
      <Seo title="Cotton - Galleon Trading" description="" keywords="" />
...
Cotton              <span className=" md:text-xl text-base py-1 md:py-8 font-semibold w-1/2">
                High-quality cotton sourced from African countries.
              </span>
              <svg
